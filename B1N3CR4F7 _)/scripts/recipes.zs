...
craftingTable.removeRecipe(<item:theabyss:abyssportalstone>);
craftingTable.removeRecipe(<item:pyromancer:vaporizer>);
craftingTable.removeRecipe(<item:netheragriculture:knife>);
craftingTable.removeRecipe(<item:netheragriculture:diamond_knife>);
craftingTable.removeRecipe(<item:netheragriculture:netherite_knife>);